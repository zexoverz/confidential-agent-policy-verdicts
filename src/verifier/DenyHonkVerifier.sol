...
uint256 constant VK_HASH = 0x197fd0d572c903685e3fd627ba3fea2e04da032a3705982c965b54e6c0b4b4a5;
uint256 constant CIRCUIT_SIZE = 131072;
uint256 constant LOG_N = 17;
uint256 constant NUMBER_PUBLIC_INPUTS = 46;
uint256 constant REAL_NUMBER_PUBLIC_INPUTS = 38;
uint256 constant PUBLIC_INPUTS_OFFSET = 5; // NUM_DISABLED_ROWS_IN_SUMCHECK + NUM_ZERO_ROWS = 4 + 1

contract DenyHonkVerifier is IVerifier {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*                    SLAB ALLOCATION                         */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    /**
...
// {{ SECTION_END MEMORY_LAYOUT }}
        ...
        returns (bool)
    {
        ...
        assembly {
            ...
            function loadVk() {
                mstore(Q_L_X_LOC, 0x2a84e040e9c1846bb36a6f73251cf8ad261773325cbf059a75a4711a41030998)
                mstore(Q_L_Y_LOC, 0x1acdc772028fec79c3fd2b11e37c4b621c9bfe711352126df0c320ad4cbd34c0)
                mstore(Q_R_X_LOC, 0x07c9c984a9305d0e1d9e67edb87f344f09696ade98a6393b39e0b8b8d38f9dfb)
                mstore(Q_R_Y_LOC, 0x2cf61f518b5f3ca3c2da8b3b61b121c4b02cc034dd265b094638b4d4a309af0a)
                mstore(Q_O_X_LOC, 0x1f93f26d31afb5f32eb5e58a6a302d1ef83595cadfed0bd80fcf99e7cf6f164a)
                mstore(Q_O_Y_LOC, 0x2f4f6dd8e539e7c81ca13e0554052cd22520e81a4226f048204520c0f7fd6fe1)
                mstore(Q_4_X_LOC, 0x1ea8847cfdfa3f59fba04a6aa67fc89c428505ab54c624cb462a3c60d4f45d96)
                mstore(Q_4_Y_LOC, 0x197b38a2004c19773ec3a2355b64080c03d3c19799a641265084a09adf328eb8)
                mstore(Q_M_X_LOC, 0x111c3ebee6228560ccc63168716d49f8876651065fa628964334a22f476a5037)
                mstore(Q_M_Y_LOC, 0x28b519dcbd4756e4d4eb1dee098647c24a406b4bf8199f936ca86450210836d8)
                mstore(Q_C_X_LOC, 0x285627742c9cf52781558eaf94d1ea65f7332427289a5679708d4a406504d722)
                mstore(Q_C_Y_LOC, 0x1f4e09604edbf660de551f60b3c37ba4bb9f837ed0f87f17c1072b1376921c50)
                mstore(Q_LOOKUP_X_LOC, 0x17fd42e84929a1a65005ed39f3759f70bc4ab9ced4de6e6c5990b895b2ba36a6)
                mstore(Q_LOOKUP_Y_LOC, 0x1e54169ccb01649d5fd517e38c682b9d0181b4c82f7cd6fb3da470729354e92b)
                mstore(Q_ARITH_X_LOC, 0x12126902dff28c1f50877146c57f87a8875701f48445bf92631454de94bb7523)
                mstore(Q_ARITH_Y_LOC, 0x21f59975ada98195ccb99f8d5f21929e1357df8a8bb96f37d06abfd5cd5af382)
                mstore(Q_DELTA_RANGE_X_LOC, 0x202ecda6530480ff388586422b57d6efb60b3fb1165494889cccbbbea57d6f6f)
                mstore(Q_DELTA_RANGE_Y_LOC, 0x04c921d4885f1db8e98e9ee0bf5aad490a1730c78901b9bfe78d9715176a0161)
                mstore(Q_ELLIPTIC_X_LOC, 0x27b0ad51200c466b9a877f59fdd6361449b577e65a022e3a9508f4a2082b9332)
                mstore(Q_ELLIPTIC_Y_LOC, 0x15df29f11f3b795a3270b106804686999678c8cdffce5d6c258fe6eeb1ee48b8)
                mstore(Q_MEMORY_X_LOC, 0x29b2e4c45796f0e70fb98081b9c74b708b42a2ec0f9523ff338d33a3bd4c9e5f)
                mstore(Q_MEMORY_Y_LOC, 0x04fdb2cd36a9a757654114113ba54381fa6dd1e2c6080e4513c64570962b9474)
                ...
                mstore(SIGMA_1_X_LOC, 0x0d526c4ff6efaa4a6abd70669a06089970f062cb09637eee10cdd8c51436898b)
                mstore(SIGMA_1_Y_LOC, 0x234ab7a72d37ea914d238758517bc6d0278cc0c1c5c5da95cb30463186fa2d0e)
                mstore(SIGMA_2_X_LOC, 0x132d05a7250294f48a4013122c6318175f68b4bfb269f8efce5efc676ddb97e6)
                mstore(SIGMA_2_Y_LOC, 0x124918fa8bc875f4b3d71d415a92779d0135e8b2efbb9d3da20c10fd15f6059c)
                mstore(SIGMA_3_X_LOC, 0x1cc8c2c002d4107a4738c5ea72c06a05c9addf55cfe5b74c09b870938fe468b7)
                mstore(SIGMA_3_Y_LOC, 0x114721f15053c003afa2abb6da2ade29e5e2470e39d130f9ad3308ebe13a1277)
                mstore(SIGMA_4_X_LOC, 0x2035d045770b6d2f9d1188ca400291d3a8d96a0f41ddfd99b499eaf71b1d6bcf)
                mstore(SIGMA_4_Y_LOC, 0x2131e3f5990f2ebc1bad7962b82a0de7dd8e08a4ff7998b3aa2080a2d3ab8f6d)
                mstore(TABLE_1_X_LOC, 0x274bebd820192daea8e46c0b7c912e465b18ac231ee25071b2dba18b00966706)
                mstore(TABLE_1_Y_LOC, 0x072595c3306f929f59bfaac21da2d8bcee88b7b192ed8a1c541b1467272bf18c)
                mstore(TABLE_2_X_LOC, 0x107f7b323e948bb9fe1622fe66804a0e2a6fdcc862de624157fdced93bb06814)
                mstore(TABLE_2_Y_LOC, 0x2ee6e025ab53e21d49a1d1a8bf7fb276326b4d822153fe65bbc4f10190c40cdd)
                mstore(TABLE_3_X_LOC, 0x182f9e3813c180572a2cbb1acaeb65a2691cbef75f838e89aa8dad8d263fe687)
                mstore(TABLE_3_Y_LOC, 0x0e01149177a28f6e4faecfb16fda28511266bccc2641d21cfcda899a0f1bb7ab)
                mstore(TABLE_4_X_LOC, 0x24e3dff9649eb332c2fe648ae76b850e95eb0998603fd050df6a32ba411774f7)
                mstore(TABLE_4_Y_LOC, 0x1beef8b76d71806356a8aea549ae50d394fd792558236967d5c34bfa60bea18d)
                mstore(ID_1_X_LOC, 0x045f9771ef2ebb484831f695e52153495c1ae8a558fc887878a737871578d05b)
                mstore(ID_1_Y_LOC, 0x13a94cd282fa4d19cc0e47a37d7d9755c8918f893d71794a46f5b57eb26ba8e9)
                mstore(ID_2_X_LOC, 0x11b8c51229913edbac61a52a5aaf28c8922531b3021f5ae6bff5605376572984)
                mstore(ID_2_Y_LOC, 0x3034b8592134c500e11ae17e56262193523baac8fcf3c73a30020fb56f6b4f1c)
                mstore(ID_3_X_LOC, 0x21cc52a33972e693d18e1ea96aea9c35e12ebe3c1a129e5761e97cd7300bdaf6)
                mstore(ID_3_Y_LOC, 0x023c6a5fca605f855891858dd893edf10151b4401c149b1fe693542f4b7641f5)
                mstore(ID_4_X_LOC, 0x2f0b8699da13366bea727c4e859d33e8afb90e6837f783e208a68fcdc34c0818)
                mstore(ID_4_Y_LOC, 0x0577fea895fda32af370510e02850fc8d12a608ac947d9772f964fb635f86819)
                ...
                mstore(LAGRANGE_LAST_X_LOC, 0x122d58b1d85718281182858e0c2d4c0e7ffc35b046f4cdcd1e1d9bc719882aa1)
                mstore(LAGRANGE_LAST_Y_LOC, 0x2621ce5d88e4a3f2fe789c541add261c23d2a6b9ff784cdf03897b6d1fcca2f3)
            }
