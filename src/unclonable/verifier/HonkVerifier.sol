...
uint256 constant VK_HASH = 0x2ce95af633c48cdf1dbe863b5adb5bfb0fe794ac5d77c800b3ab02665aee6ec9;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x0b34025e64a98d8be047288d75ffa311f8bd9fe0bbce327179615ff0fbbc8e3a),
               y: uint256(0x0c63af2b5fa1097478ef7f672f39660a35461d5ceb17649d43f1f858e6dde591)
            }),
            qr: Honk.G1Point({ 
               x: uint256(0x161d125fed9fd49e6d9de3da6967e18895b9470bfa882169b3bca4dd31be86fd),
               y: uint256(0x1ff0a9d13df406c8c2870f814b37a47157f97f958e5e3911bc8dd843f6916746)
            }),
            qo: Honk.G1Point({ 
               x: uint256(0x1045dd605a449416979fb807a1914d46de0e737aad0a2a17171ed9ab030b6ffe),
               y: uint256(0x2703bf6120b25ddce53a3d08e0d06cb580618313e48456b0a3cb9f5f17c36c42)
            }),
            q4: Honk.G1Point({ 
            ...
            qm: Honk.G1Point({ 
               x: uint256(0x17fb12773c2636b77e6efc61b2017ec18cbfda9ca96464d01a74d50eb8b633ce),
               y: uint256(0x07c1fcbcba5621b458569978d10a39934b0d9cbb8501b3024c946348ec488731)
            }),
            qc: Honk.G1Point({ 
               x: uint256(0x299cc96c443829dd6c2bf6a7e297d497ddc29dc384ef01639f0e3473aae14f03),
               y: uint256(0x28349060cd1643259368370a58b9174c14a7548f83476f83fb1b02a163ea9203)
            }),
            ...
            qArith: Honk.G1Point({ 
               x: uint256(0x1ab1f6fcc47803fc10d2be9d24ccd48bb4ea1842c2b1dbe05c0aa957f4ccbf53),
               y: uint256(0x2a0355abd66a34386b3b3be3a737896ba0c72398e8565ca0c161fa321a6d2384)
            }),
            ...
            s1: Honk.G1Point({ 
               x: uint256(0x10c0d01fe0b100abaa00f893602719f4eab83925834b9b38780747895580c55a),
               y: uint256(0x289cd8fbe2673af4078c5ba7b772733a9f0a9eb17a986c91414e5429149f9623)
            }),
            s2: Honk.G1Point({ 
               x: uint256(0x28a577f87f994c56ded2048a33b02c4fc0387eb241eabe203023c8c50bfc1f52),
               y: uint256(0x03735a5f9779e257740419ff3ed16ee3310ec0ad6ba0265b1f111a132b3d37bc)
            }),
            s3: Honk.G1Point({ 
               x: uint256(0x2055078eb36b170c812050ad395b20819c93e8a46a197eae73f78eedeb70b647),
               y: uint256(0x0d85a593fe9b157ec99a06b2563d32027c91a388b80886680a384ae7eddc8108)
            }),
            s4: Honk.G1Point({ 
               x: uint256(0x1914fb8220fc4523b7f4a17f51e2d51d88df4abd616b2dbbe72c31acebb49410),
               y: uint256(0x057de0ef5bc42cb412f7c58e0910dd558fb78641aefb2e7503c2d3cc447b53e2)
            }),
            t1: Honk.G1Point({ 
            ...
            id1: Honk.G1Point({ 
               x: uint256(0x185f652c744b2de95a32fb595f81f14983eefea017cafe4f8114d16823dc8bcf),
               y: uint256(0x155892771e592656e7e8db61a712a6cb933443b3e4a54240e14fa300abf9eaf2)
            }),
            id2: Honk.G1Point({ 
               x: uint256(0x205d8257daa4a12a5643b391bc62c298da1301bc738804d978df6ebfe3dad79a),
               y: uint256(0x2ac7487c80ce79a4a1cf612f134a688557e5b3e833ee639fd432318c385c1afb)
            }),
            id3: Honk.G1Point({ 
               x: uint256(0x2c5f653c65f9c9d1afd8723a865e229619188bfca2c7e2444803137fb4cbf47e),
               y: uint256(0x1fd22df861265d1c122432b49c5a1fd5aa21115c996aa1659210d75b40bd2e43)
            }),
            id4: Honk.G1Point({ 
               x: uint256(0x300e0377b456dec445b7dddb230f2d075e806103473eda9c6fe96650d75081cc),
               y: uint256(0x2133ffe6e1f753bc5fc409f2ef58202b69314e6085d03e42520ac0b366a511d7)
            }),
